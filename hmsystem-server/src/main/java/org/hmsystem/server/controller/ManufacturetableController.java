...
public class ManufacturetableController {
    ...
    @ApiOperation(value = "增加制造商信息")
    @PostMapping("/insertManufactureInfo")
    public RespBean addManufactureInfo(@RequestParam("manufacturename") String manufactureName) {
        Manufacturetable manufacturetable = new Manufacturetable();
        manufacturetable.setManufacturenum(getAllList().size()+1);
        manufacturetable.setManufacturername(manufactureName);
